...
// TODO:
// 
// - if added to scene other than the camera scene,
// make sure that you update not based on camera movement,
// but just scene movement!
//
//
//
//
...
//
  ...
  function ObjectControls( eye , hand, controller , params ){
    ...
    this.selectionStrength  = params.selectionStrength  || .9;
    ...
    // and update selected
    this.upDownEvent        = params.upDownEvent        || function(){}//this.pinchEvent
